...
PRODUCTION_POLICY_PATHS = frozenset(
    {
        ...
        ".github/scripts/test_verify_cli_release.py",
        ".github/scripts/validate_next_provenance.py",
        ".github/scripts/verify_cli_release.py",
...
STAGING_ONLY_PATHS = frozenset(
    {
        ...
        ".github/scripts/release_dependency.py",
        ".github/scripts/test_attest_staging_promotion.py",
        ".github/scripts/test_promote_to_prod_contract.py",
        ".github/scripts/test_release_dependency.py",
        ".github/workflows/promote-to-prod.yml",
    }
)

# Deterministic CLI-specific transforms performed by promote-to-prod.yml after
# copying the attested staging tree.
PROMOTION_TRANSFORM_PATHS = frozenset({"go.mod", "go.sum"})
