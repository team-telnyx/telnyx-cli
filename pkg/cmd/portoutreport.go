...
func handlePortoutsReportsCreate(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(os.Stdout, os.Stderr, "portouts:reports create", obj, format, explicitFormat, transform)
}
...
func handlePortoutsReportsRetrieve(ctx context.Context, cmd *cli.Command) error {
	...
	explicitFormat := cmd.Root().IsSet("format")
	transform := cmd.Root().String("transform")
	return ShowJSON(os.Stdout, os.Stderr, "portouts:reports retrieve", obj, format, explicitFormat, transform)
}
...
func handlePortoutsReportsList(ctx context.Context, cmd *cli.Command) error {
	...
	if format == "raw" {
		...
		obj := gjson.ParseBytes(res)
		return ShowJSON(os.Stdout, os.Stderr, "portouts:reports list", obj, format, explicitFormat, transform)
	} else {
		...
		return ShowJSONIterator(os.Stdout, os.Stderr, "portouts:reports list", iter, format, explicitFormat, transform, maxItems)
	}
}
