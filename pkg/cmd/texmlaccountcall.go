...
var texmlAccountsCallsCalls = requestflag.WithInnerFlags(cli.Command{
	...
	Flags: []cli.Flag{
		...
		&requestflag.Flag[string]{
			...
			BodyPath: "DeepfakeDetection",
		},
		&requestflag.Flag[string]{
			Name:     "deepfake-detection-callback-method",
			Usage:    "HTTP request type used for `DeepfakeDetectionCallbackUrl`.",
			Default:  "POST",
			BodyPath: "DeepfakeDetectionCallbackMethod",
		},
		&requestflag.Flag[string]{
			Name:     "deepfake-detection-callback-url",
			Usage:    "URL destination for Telnyx to send deepfake detection callback events to for the call.",
			BodyPath: "DeepfakeDetectionCallbackUrl",
		},
		&requestflag.Flag[string]{
			Name:     "detection-mode",
