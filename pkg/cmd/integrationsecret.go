...
func handleIntegrationSecretsCreate(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(os.Stdout, os.Stderr, "integration-secrets create", obj, format, explicitFormat, transform)
}
...
func handleIntegrationSecretsList(ctx context.Context, cmd *cli.Command) error {
	...
	if format == "raw" {
		...
		obj := gjson.ParseBytes(res)
		return ShowJSON(os.Stdout, os.Stderr, "integration-secrets list", obj, format, explicitFormat, transform)
	} else {
		...
		return ShowJSONIterator(os.Stdout, os.Stderr, "integration-secrets list", iter, format, explicitFormat, transform, maxItems)
	}
}
