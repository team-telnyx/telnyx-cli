...
func init() {
	Command = &cli.Command{
		...
		Commands: []*cli.Command{
			...
			{
				Name:     "whatsapp:phone-numbers:conversational-components",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&whatsappPhoneNumbersConversationalComponentsList,
					&whatsappPhoneNumbersConversationalComponentsPatchAll,
				},
			},
			{
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					&emailDomainsList,
					&emailDomainsDelete,
					&emailDomainsRetrieveDNSRecords,
					&emailDomainsRetrieveHealth,
					&emailDomainsVerify,
				},
			},
			{
				Name:     "email-domains:webhooks",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailDomainsWebhooksCreate,
					&emailDomainsWebhooksRetrieve,
					&emailDomainsWebhooksUpdate,
					&emailDomainsWebhooksList,
					&emailDomainsWebhooksDelete,
				},
			},
			{
				Name:     "email-events",
			...
			},
			{
				...
				Commands: []*cli.Command{
					&emailInboxesCreate,
					&emailInboxesRetrieve,
					&emailInboxesList,
					&emailInboxesDelete,
				},
			},
			{
				Name:     "email-inboxes:drafts",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailInboxesDraftsCreate,
					&emailInboxesDraftsRetrieve,
					&emailInboxesDraftsUpdate,
					&emailInboxesDraftsList,
					&emailInboxesDraftsDelete,
					&emailInboxesDraftsPatch,
					&emailInboxesDraftsSend,
				},
			},
			{
				Name:     "email-inboxes:filters",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailInboxesFiltersList,
					&emailInboxesFiltersAdd,
					&emailInboxesFiltersDeleteAll,
					&emailInboxesFiltersReplace,
				},
			},
			{
				Name:     "email-inboxes:messages",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailInboxesMessagesUpdate,
					&emailInboxesMessagesList,
					&emailInboxesMessagesDrafts,
				},
			},
			{
				Name:     "email-inboxes:messages:actions",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailInboxesMessagesActionsForward,
					&emailInboxesMessagesActionsReply,
					&emailInboxesMessagesActionsReplyAll,
				},
			},
			{
				Name:     "email-inboxes:messages:labels",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailInboxesMessagesLabelsCreate,
					&emailInboxesMessagesLabelsDeleteAll,
				},
			},
			{
				Name:     "email-inboxes:threads",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailInboxesThreadsRetrieve,
					&emailInboxesThreadsList,
				},
			},
			{
				Name:     "email-inboxes:threads:labels",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailInboxesThreadsLabelsCreate,
					&emailInboxesThreadsLabelsDeleteAll,
				},
			},
			{
				Name:     "email-messages",
				...
				Commands: []*cli.Command{
					...
					&emailMessagesDelete,
					&emailMessagesBatch,
					&emailMessagesDeleteAll,
					&emailMessagesDeleteSchedule,
					&emailMessagesRetrieveEvents,
				},
			},
			{
				Name:     "email-messages:recipients",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailMessagesRecipientsRetrieve,
					&emailMessagesRecipientsList,
				},
			},
			{
			...
			},
			{
				...
				Suggest:  true,
				Commands: []*cli.Command{
					&emailUnsubscribeGroupsCreate,
					&emailUnsubscribeGroupsRetrieve,
					&emailUnsubscribeGroupsUpdate,
					&emailUnsubscribeGroupsList,
					&emailUnsubscribeGroupsDelete,
				},
			},
			{
				Name:     "email-unsubscribe-groups:suppressions",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailUnsubscribeGroupsSuppressionsCreate,
					&emailUnsubscribeGroupsSuppressionsList,
					&emailUnsubscribeGroupsSuppressionsDelete,
				},
			},
			{
				...
				Suggest:  true,
				Commands: []*cli.Command{
					&emailValidationsCreate,
				},
			},
			{
				Name:     "email-validations:batch",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&emailValidationsBatchCreate,
					&emailValidationsBatchRetrieve,
				},
			},
			{
