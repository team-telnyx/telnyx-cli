...
func handleReportsListMdrs(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(os.Stdout, os.Stderr, "reports list-mdrs", obj, format, explicitFormat, transform)
}
...
func handleReportsListWdrs(ctx context.Context, cmd *cli.Command) error {
	...
	if format == "raw" {
		...
		obj := gjson.ParseBytes(res)
		return ShowJSON(os.Stdout, os.Stderr, "reports list-wdrs", obj, format, explicitFormat, transform)
	} else {
		...
		return ShowJSONIterator(os.Stdout, os.Stderr, "reports list-wdrs", iter, format, explicitFormat, transform, maxItems)
	}
}
