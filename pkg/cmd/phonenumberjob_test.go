...
func TestPhoneNumbersJobsList(t *testing.T) {
	...
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			...
			"--max-items", "10",
			"--filter", "{phone_number: '+15551234567,1234567890123456789', status: [pending, in_progress], type: update_emergency_settings}",
			"--page-number", "0",
			"--page-size", "0",
			"--sort", "created_at",
		)
	...
	t.Run("inner flags", func(t *testing.T) {
		...
		mocktest.TestRunMockTestWithFlags(
			...
			"phone-numbers:jobs", "list",
			"--max-items", "10",
			"--filter.phone-number", "+15551234567,1234567890123456789",
