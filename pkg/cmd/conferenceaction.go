...
var conferencesActionsRecordPause = cli.Command{
	Name:    "record-pause",
	Usage:   "Pauses the active recording of the specified conference. Resume it later with\nthe record_resume action.",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "id",
...
var conferencesActionsRecordResume = cli.Command{
	Name:    "record-resume",
	Usage:   "Resumes a previously paused recording of the specified conference, continuing\ncapture from the point it was paused.",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "id",
