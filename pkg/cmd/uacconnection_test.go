...
func TestUacConnectionsCreate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"uac-connections", "create",
	...
	t.Run("inner flags", func(t *testing.T) {
		...
		requestflag.CheckInnerFlags(uacConnectionsCreate)
		...
		mocktest.TestRunMockTestWithFlags(
			...
			"--encode-contact-header-enabled=true",
			"--encrypted-media", "SRTP",
			"--external-uac-settings.auth-username", "auth8492",
			"--external-uac-settings.expiration-sec", "600",
			"--external-uac-settings.from-user", "8492",
			"--external-uac-settings.outbound-proxy", "outbound.sip-pbx.acme.example:5061",
...
func TestUacConnectionsRetrieve(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"uac-connections", "retrieve",
			"--id", "id",
		)
	})
}

func TestUacConnectionsUpdate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"uac-connections", "update",
			"--id", "id",
			"--active=true",
			"--anchorsite-override", "Latency",
			"--android-push-credential-id", "06b09dfd-7154-4980-8b75-cebf7a9d4f8e",
	...
	t.Run("inner flags", func(t *testing.T) {
		// Check that inner flags have been set up correctly
		requestflag.CheckInnerFlags(uacConnectionsUpdate)
...
func TestUacConnectionsList(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"uac-connections", "list",
			"--max-items", "10",
	...
	t.Run("inner flags", func(t *testing.T) {
		// Check that inner flags have been set up correctly
		requestflag.CheckInnerFlags(uacConnectionsList)
...
func TestUacConnectionsDelete(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"uac-connections", "delete",
			"--id", "id",
		)
	})
}
