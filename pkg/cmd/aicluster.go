...
func handleAIClustersRetrieve(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(os.Stdout, os.Stderr, "ai:clusters retrieve", obj, format, explicitFormat, transform)
}
...
func handleAIClustersList(ctx context.Context, cmd *cli.Command) error {
	...
	if format == "raw" {
		...
		obj := gjson.ParseBytes(res)
		return ShowJSON(os.Stdout, os.Stderr, "ai:clusters list", obj, format, explicitFormat, transform)
	} else {
		...
		return ShowJSONIterator(os.Stdout, os.Stderr, "ai:clusters list", iter, format, explicitFormat, transform, maxItems)
	}
}
...
func handleAIClustersCompute(ctx context.Context, cmd *cli.Command) error {
	...
	explicitFormat := cmd.Root().IsSet("format")
	transform := cmd.Root().String("transform")
	return ShowJSON(os.Stdout, os.Stderr, "ai:clusters compute", obj, format, explicitFormat, transform)
}
