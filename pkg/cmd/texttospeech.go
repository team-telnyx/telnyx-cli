...
var textToSpeechCreateSpeech = requestflag.WithInnerFlags(cli.Command{
	Name:    "create-speech",
	...
	Action:          handleTextToSpeechCreateSpeech,
...
var textToSpeechGenerateSpeech = cli.Command{
...
func handleTextToSpeechCreateSpeech(ctx context.Context, cmd *cli.Command) error {
	...
	params := telnyx.TextToSpeechNewSpeechParams{}

	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.TextToSpeech.NewSpeech(ctx, params, options...)
	if err != nil {
		return err
	}
	...
	return ShowJSON(obj, ShowJSONOpts{
		...
		Title:          "text-to-speech create-speech",
		Transform:      transform,
	})
}
...
func handleTextToSpeechGenerateSpeech(ctx context.Context, cmd *cli.Command) error {
	...
	return client.TextToSpeech.GenerateSpeech(ctx, params, options...)
}
