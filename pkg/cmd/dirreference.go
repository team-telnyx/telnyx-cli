...
var dirReferencesCreate = requestflag.WithInnerFlags(cli.Command{
	Name:    "create",
	...
	Action:          handleDirReferencesCreate,
...
func handleDirReferencesCreate(ctx context.Context, cmd *cli.Command) error {
	...
	params := telnyx.DirReferenceNewParams{}
